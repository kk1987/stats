...
//  Tests
//
//  Persistent usage history: the on-disk archive — the ring, the header and
//  directory, the corruption paths and the fixed geometry the format is.
//  Fixtures in `HistoryTestSupport.swift`.
//  Design: docs/usage-history-design.md (§3, §10), exelban/stats#1194.
//

import XCTest
import Kit

final class HistoryArchiveTests: HistoryTestCase {
